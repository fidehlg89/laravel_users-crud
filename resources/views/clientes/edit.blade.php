...
@section('content')
        ...
        <div class="grid">
            <div class="flex justify-between md:col-span-2 items-center px-4 sm:px-0">
                ...
                <a href="javascript:history.back()" class="text-lg font-medium leading-6 text-indigo-600 hover:text-indigo-900">Atras</a>
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="last-name" class="block text-sm font-medium text-gray-700">Apellidos del
                                        Cliente</label>
                                    <input type="text" name="app" id="app" value="{{ $client->app }}"required
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"/>
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="ci" class="block text-sm font-medium text-gray-700">No. Carnet de
                                        Identidad</label>
                                    <input type="text" name="ci" id="ci" value="{{ $client->ci }}"required
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"/>
                                </div>
